...
void drawSimpleMode()
{
    ...
    drawHorizentalyCenteredText("PRESS F TO TOGGEL FullScreen", 290);
    drawHorizentalyCenteredText("PRESS F11 to full screen", 320);
}
...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        if (IsKeyPressed(KEY_F))
        {
          ...
          } else SetWindowState(FLAG_WINDOW_MAXIMIZED);
        };
